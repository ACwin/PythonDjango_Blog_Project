    ...
    if request.method == 'POST':
        ...
        if user_login_form.is_valid():
            ...
            if user:
                ...
                return HttpResponse("The username or password was entered incorrectly. please enter again~")
        else:
...
def user_register(request):
    if request.method == 'POST':
        ...
        if user_register_form.is_valid():
            ...
            return HttpResponse("Please check again whether the entered password meets the criteria and re-enter~")
    elif request.method == 'GET':
